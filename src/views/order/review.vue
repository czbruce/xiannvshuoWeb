<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.type" placeholder="评价等级" clearable class="filter-item" style="width: 150px; margin-right: 30px">
    ...
    >
      ...
      <el-table-column label="评价等级 " width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.author }}</span>
        </template>
      </el-table-column>
      <el-table-column label="评价" min-width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.author }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="启用状态" width="80px" align="center">
        <template slot-scope="{row}">
          <el-button type="success" size="mini">{{ row.reviewer }}</el-button>
        </template>
      </el-table-column>
      <el-table-column label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          <el-button v-if="row.status !='deleted'" type="success" size="mini" @click="handleModifyStatus(row,'draft')">
            隐藏
          </el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="90px" style="width: 80%; margin-left:50px;">
        <el-form-item label="商品选择" prop="release">
        ...
        <el-form-item label="评价等级" style="width: 50%">
        ...
        <el-form-item label="上传图片" prop="release">
          <dropzone id="myVueDropzone" url="https://httpbin.org/post" thumbnail-height="160" thumbnail-width="160" @dropzone-removedFile="dropzoneR" @dropzone-success="dropzoneS" />
        </el-form-item>
